...
o	SecureTrust Data Loss Prevention 
o	Check Point Data Loss Prevention 
•	IAM Tools: 
o	SailPoint IdentityIQ 
o	RSA SecurID Suite 
o	Core Access Assurance Suite
Detection Control
•	IDS/IPS Tools: 
o	Check Point IPS Software Blade 
o	IBM Security Network Intrusion Prevention System 
o	AlienVault Unified Security Management
•	Log Management Tools:
o	SolarWinds Security Event Manager 
o	Splunk 
o	Loggly 
•	SIEM Tools: 
o	ArcSight ESM 
o	LogRhythm NextGen SIEM Platform 
